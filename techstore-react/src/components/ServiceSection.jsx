        ...
        <section id="servicio-tecnico" className="seccion-oscura">
            <div className="servicio-contenedor">
                <div className="servicio-texto">
                    ...
                    <p>
                        No solo te ofrecemos los mejores componentes del mercado, también contamos con un
                        laboratorio técnico para darle una segunda vida a tu computadora o armar tu setup desde cero.
                    </p>

                    <ul className="lista-servicios">
                        <li>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                                stroke="#ff5722" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className="servicio-imagen">
                    <img
                        src="https://images.unsplash.com/photo-1597872200969-2b65d56bd16b?w=800"
                        alt="Técnico reparando una computadora"
                    />
                </div>
            </div>
        </section>
